...
export default function NotificationCard({message, link = null, linkText = null} : {message: string, link: string | null, linkText: string | null}){
    return(
        <dialog open className="fixed top-10 md:px-13 px-8 py-5 rounded-2xl border-none sm:mx-auto mx-6 sm:w-fit w-auto my-0 bg-product-added flex flex-col gap-4 items-center">
